function [current_pressure, pressure_loss, gravity_gain] = pressure_drop_down(m_dot, pressure1)
...
%   Detailed explanation goes here
    ...
    for height = 0 : delta_l : 3200 - delta_l
        ...
        p2 = current_pressure * exp((-1/(R * temp)) * (velo_diff +  gravity * -1 * delta_l));
        gravity_gain = gravity_gain + p2 - current_pressure ;
        current_pressure = p2;
